...
class plugin_info{
    ...
    static $PLUGIN_CODE       = "RealShop";
    /** プラグイン名(必須)：EC-CUBE上で表示されるプラグイン名. */
    static $PLUGIN_NAME       = "店舗登録";
    ...
    /** 説明(必須)：プラグインの説明. */
    static $DESCRIPTION       = "店舗情報の登録・編集ができます。";
    ...
    static $CLASS_NAME       = "RealShop";
    /** フックポイント：フックポイントとコールバック関数を定義します */
    static $HOOK_POINTS       = array(
        array("prefilterTransform", 'prefilterTransformRealShop'));
    /** ライセンス */
    static $LICENSE        = "LGPL";
}
?>
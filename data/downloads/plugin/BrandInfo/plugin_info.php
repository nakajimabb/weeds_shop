...
class plugin_info{
    ...
    static $PLUGIN_CODE       = "BrandInfo";
    /** プラグイン名(必須)：EC-CUBE上で表示されるプラグイン名. */
    static $PLUGIN_NAME       = "ブランド登録";
    ...
    /** 説明(必須)：プラグインの説明. */
    static $DESCRIPTION       = "ブランド情報の登録・編集ができます。";
    ...
    static $CLASS_NAME       = "BrandInfo";
    /** フックポイント：フックポイントとコールバック関数を定義します */
    static $HOOK_POINTS       = array(
        array("prefilterTransform", 'prefilterTransformBrandInfo'));
    /** ライセンス */
    static $LICENSE        = "LGPL";
}
?>
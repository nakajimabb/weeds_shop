...
class plugin_info{
    ...
    static $PLUGIN_CODE       = "CustomerCSV";
    /** プラグイン名(必須)：EC-CUBE上で表示されるプラグイン名. */
    static $PLUGIN_NAME       = "会員登録CSV";
    ...
    /** 説明(必須)：プラグインの説明. */
    static $DESCRIPTION       = "CSVファイルから会員情報を登録します";
    ...
    static $CLASS_NAME       = "CustomerCSV";
    /** フックポイント：フックポイントとコールバック関数を定義します */
    static $HOOK_POINTS       = array(
        array("prefilterTransform", 'prefilterTransformCustomerCSV'));
    /** ライセンス */
    static $LICENSE        = "LGPL";
}
?>
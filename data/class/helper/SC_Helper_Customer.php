...
class SC_Helper_Customer
{
    ...
    public function sfCustomerCommonParam(&$objFormParam, $prefix = '')
    {
        ...
        $objFormParam->addParam('社員番号', $prefix . 'staff_no', STEXT_LEN, 'aKV', array('EXIST_CHECK', 'NO_SPTAB', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
    }
    ...
    public function sfSetSearchParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('社員番号', 'search_staff_no', STEXT_LEN, 'KVa', array('SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
    }

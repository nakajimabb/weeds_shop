                    ...
                    <tr>
                        ...
                        <td><a<!--{if $orderDetail.enable}--> href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$orderDetail.product_id|u}-->"<!--{/if}-->><!--{$orderDetail.product_name|h}--></a><br />
                            <!--{if $orderDetail.classcategory_name1 != ""}-->
                                種類：[<!--{$orderDetail.classcategory_name1|h}-->]<br />
                            <!--{/if}-->
                            <!--{if $orderDetail.classcategory_name2 != ""}-->
                                <!--{$orderDetail.classcategory_name2|h}-->
                            <!--{/if}-->
                        </td>
                        <td class="alignR"><!--{$orderDetail.price|number_format|h}-->円
                        <!--{if $orderDetail.price != $orderDetail.product_price}-->
                            <div class="attention">【現在価格】</div><span class="attention"><!--{$orderDetail.product_price|number_format|h}-->円</span>
                        <!--{/if}-->
                        </td>
                        <td class="alignR"><!--{$orderDetail.quantity|h}--></td>
                        <td class="alignR"><!--{$orderDetail.price|sfMultiply:$orderDetail.quantity|number_format}-->円</td>
                    </tr>
                <!--{/foreach}-->
                <tr>
                    <th colspan="4" class="alignR">消費税</th>
                    <td class="alignR"><!--{$tpl_arrOrderData.tax|number_format}-->円</td>
                </tr>
                <!--{if false}-->
                    <tr>

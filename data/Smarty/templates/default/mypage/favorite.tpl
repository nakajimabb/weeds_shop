                ...
                <!--{if $tpl_linemax > 0}-->
                    ...
                    <table summary="お気に入り">
                        ...
                        <tr>
                            ...
                            <th class="alignC"><!--{$smarty.const.SALE_PRICE_TITLE}-->(税抜)</th>
                        </tr>
                                ...
                                <td class="alignR sale_price">
                                    <span class="price">
                                        <!--{if $arrFavorite[cnt].price02_min == $arrFavorite[cnt].price02_max}-->
                                            <!--{$arrFavorite[cnt].price02_min|number_format}-->
                                        <!--{else}-->
                                            <!--{$arrFavorite[cnt].price02_min|number_format}-->～<!--{$arrFavorite[cnt].price02_max|number_format}-->
                                        <!--{/if}-->円</span>
                                </td>
                            </tr>
                        <!--{/section}-->
